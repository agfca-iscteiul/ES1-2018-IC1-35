...
public class Display {
	...
	private void initialize() {
		...
		springLayout.putConstraint(SpringLayout.SOUTH, lblAutor, -430, SpringLayout.SOUTH,
				frmDetalhes.getContentPane());
		...
		springLayout.putConstraint(SpringLayout.WEST, textPaneDate, 361, SpringLayout.WEST,
				frmDetalhes.getContentPane());
		...
		springLayout.putConstraint(SpringLayout.EAST, textPaneDate, -10, SpringLayout.EAST,
				frmDetalhes.getContentPane());
		...
		springLayout.putConstraint(SpringLayout.SOUTH, scrollPane_1, 0, SpringLayout.SOUTH,
				frmDetalhes.getContentPane());
